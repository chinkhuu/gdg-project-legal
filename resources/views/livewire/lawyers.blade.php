        ...
        <div class="flex flex-col sm:flex-row sm:justify-center items-center gap-4 mb-10">
            ...
            <div class="relative w-full sm:w-auto">
                <flux:input icon="magnifying-glass"
                            ...
                            placeholder="Хуульчийг хайх..." clearable/>
            </div>
        </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-6 sm:gap-8 p-1">
                                <div class="flex-shrink-0 text-center sm:text-left">
                                    <img
                                        ...
                                        src="{{ Storage::url($lawyer->profile) ?? 'https://ui-avatars.com/api/?name=' . urlencode($lawyer->name) . '&background=f59e0b&color=fff&size=160' }}"
                                        alt="{{ $lawyer->name }}"
                                    >
